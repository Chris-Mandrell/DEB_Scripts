"""Command line post-processing patch to PlanetarySystemStacker
...
class PssConsole(QtCore.QObject):
    ...
    def setup_configuration(self):
        ...
        parser.add_argument("--post", action="store",help="run in auto mode with postprocessing only if required configuration file exists")
